...
int main(int argc, char** argv)
{
    ...
    std::string target = std::string(DATA_PATH) + "/ldbn1024.pcf";
    ...
    app.add_option("--target", target, "PCF Target")->capture_default_str();
    ...
    PCF pcf(N, D, 0.001, 0.01, 0.05, 100, target);
